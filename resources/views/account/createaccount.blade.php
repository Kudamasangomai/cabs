<x-app-layout>
    <div class="flex flex-row flex-wrap">
        <div class="flex-shrink w-full max-w-full px-3 md:px-4">
            <div class="flex flex-row items-center justify-between">
                <p class="my-3 text-lg font-bold">Create Account </p>
                <!-- btn action -->
                <div class="flex flex-row items-center justify-between">
    ...
    <x-splade-form action="{{ route('account.store') }}" method="POST"  class="flex flex-row flex-wrap -mx-4 valid-form">
        ...
        <div class="flex-shrink w-full max-w-full px-4 mb-4 form-group">
            ...
            <x-splade-file name="image" class="block w-full  text-gray-900 border rounded-lg cursor-pointer bg-gray-50 "/>
        </div>
